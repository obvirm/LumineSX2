...
extern "C" {
    // VMManager functions
    fn VMManager_HasValidVM() -> bool;
    fn VMManager_GetState() -> c_int;
    fn VMManager_SetState(state: c_int) -> bool;
    fn VMManager_SetPaused(paused: bool);
    fn VMManager_InitializeAsync(
        params: *const c_void,
        hardcore_callback: *const c_void,
        done_callback: *const c_void,
    );
    fn VMManager_Shutdown(save_state: bool);
    fn VMManager_Reset();
    fn VMManager_Stop();
    fn VMManager_LoadState(filename: *const c_char, error: *mut c_void) -> bool;
    fn VMManager_LoadStateFromSlot(slot: c_int, load_backup: bool, error: *mut c_void) -> bool;
    fn VMManager_SaveState(filename: *const c_char, comp_freeze: bool, backup: bool, callback: *const c_void);
    fn VMManager_SaveStateToSlot(slot: c_int, comp_freeze: bool, callback: *const c_void);
    fn VMManager_ChangeDisc(source_type: c_uint, filename: *const c_char);
    fn VMManager_SetELFOverride(filename: *const c_char);
    fn VMManager_ChangeGSDump(filename: *const c_char);
    fn VMManager_ReloadPatches(geotoolkit: bool, verbose: bool, show: bool, apply: bool);
    fn VMManager_ReloadInputSources();
    fn VMManager_ReloadInputBindings();
    fn VMManager_ReloadGameSettings();
    fn VMManager_RequestDisplaySize(scale: f32);
    fn VMManager_ApplySettings();
    fn VMManager_UpdateTargetSpeed();
    fn VMManager_GetLimiterMode() -> c_int;
    fn VMManager_IdlePollUpdate();
    fn VMManager_Internal_CPUThreadInitialize() -> bool;
    fn VMManager_Internal_CPUThreadShutdown();
    fn VMManager_Internal_UpdateEmuFolders();
    fn VMManager_Internal_SetFileLogPath(path: *const c_char);
    fn VMManager_Internal_LoadStartupSettings();
    fn VMManager_Internal_CheckSettingsVersion() -> bool;
    fn VMManager_PerformEarlyHardwareChecks(error: *mut *const c_char) -> bool;
    fn VMManager_EMU_THREAD_STACK_SIZE() -> c_uint;
    fn VMManager_SetDefaultSettings(
        si: *const c_void,
        folders: bool,
        core: bool,
        controllers: bool,
    ...
    // Host functions
    fn Host_GetBaseBoolSettingValue(section: *const c_char, key: *const c_char, default_val: bool) -> bool;
    fn Host_SetBaseBoolSettingValue(section: *const c_char, key: *const c_char, value: bool);
    fn Host_GetBoolSettingValue(section: *const c_char, key: *const c_char, default_val: bool) -> bool;
    fn Host_SetBoolSettingValue(section: *const c_char, key: *const c_char, value: bool);
    fn Host_GetBaseIntSettingValue(section: *const c_char, key: *const c_char, default_val: c_int) -> c_int;
    fn Host_SetBaseIntSettingValue(section: *const c_char, key: *const c_char, value: c_int);
    fn Host_GetBaseStringSettingValue(section: *const c_char, key: *const c_char) -> *const c_char;
    fn Host_SetBaseStringSettingValue(section: *const c_char, key: *const c_char, value: *const c_char);
    fn Host_CommitBaseSettingChanges();
    fn Host_InBatchMode() -> bool;
    fn Host_InNoGUIMode() -> bool;
    fn Host_ReportErrorAsync(title: *const c_char, message: *const c_char);
    fn Host_ReportInfoAsync(title: *const c_char, message: *const c_char);
    fn Host_ReportError(title: *const c_char, message: *const c_char);
    fn Host_AddOSDMessage(key: *const c_char, message: *const c_char, duration: f32);
    fn Host_AddIconOSDMessage(key: *const c_char, icon: *const c_char, message: *const c_char, duration: f32);
    fn Host_RemoveKeyedOSDMessage(key: *const c_char);
    fn Host_GetHTTPUserAgent() -> *const c_char;
    fn Host_GetSettingsLock() -> *mut c_void;
    fn Host_SetDefaultUISettings(si: *const c_void);
    fn Host_GetMainWindow() -> *mut c_void;
    fn Host_GetMainWindowWidth() -> c_int;
    fn Host_GetMainWindowHeight() -> c_int;
    fn Host_IsFullscreen() -> bool;
    fn Host_SetFullscreen(enabled: bool);
    fn Host_GetGameListEntryCount() -> c_uint;
    fn Host_GetGameListEntry(index: c_uint) -> *const c_void;
    fn Host_RefreshGameListAsync(invalidate_cache: bool);
    fn Host_CancelGameListRefresh();
    fn Host_RequestExitApplication(allow_confirm: bool);
    fn Host_RequestExitBigPicture();
    fn Host_RequestVMShutdown(allow_confirm: bool, allow_save_state: bool, default_save_state: bool);
    fn Host_CopyTextToClipboard(text: *const c_char) -> bool;
    fn Host_GetTextFromClipboard() -> *const c_char;
    fn Host_BeginTextInput();
    fn Host_EndTextInput();
    fn Host_OpenURL(url: *const c_char);
    fn Host_GetTopLevelWindowInfo(info: *mut c_void) -> bool;

    // Host callbacks
    fn Host_OnVMStarting();
    fn Host_OnVMStarted();
    fn Host_OnVMDestroyed();
    fn Host_OnVMPaused();
    fn Host_OnVMResumed();
    fn Host_OnPerformanceMetricsUpdated();
    fn Host_OnSaveStateLoading(filename: *const c_char);
    fn Host_OnSaveStateLoaded(filename: *const c_char, was_successful: bool);
    fn Host_OnSaveStateSaved(filename: *const c_char);
    fn Host_OnGameChanged(
        title: *const c_char,
        elf_override: *const c_char,
        disc_path: *const c_char,
        serial: *const c_char,
        disc_crc: c_uint,
        current_crc: c_uint,
    );
    fn Host_OnInputDeviceConnected(identifier: *const c_char, device_name: *const c_char);
    fn Host_OnInputDeviceDisconnected(key: c_uint, identifier: *const c_char);
    fn Host_OnCaptureStarted(filename: *const c_char);
    fn Host_OnCaptureStopped();
    fn Host_OnAchievementsLoginRequested(reason: c_int);
    fn Host_OnAchievementsLoginSuccess(username: *const c_char, points: c_uint, sc_points: c_uint, unread_messages: c_uint);
    fn Host_OnAchievementsRefreshed();
    fn Host_OnAchievementsHardcoreModeChanged(enabled: bool);
    fn Host_SetMouseMode(relative_mode: bool, hide_cursor: bool);
    fn Host_SetMouseLock(state: bool);
    fn Host_AcquireRenderWindow(recreate_window: bool, info: *mut c_void) -> bool;
    fn Host_ReleaseRenderWindow();
    fn Host_BeginPresentFrame();
    fn Host_RequestResizeHostDisplay(width: c_int, height: c_int);
    fn Host_PumpMessagesOnCPUThread();
    fn Host_RunOnCPUThread(function: *const c_void, block: bool);
    fn Host_RunOnGSThread(function: *const c_void);
    fn Host_RefreshGameList(invalidate_cache: bool);
    fn Host_ShouldPreferHostFileSelector() -> bool;
    fn Host_OpenHostFileSelectorAsync(
        title: *const c_char,
    ...
    fn Host_CreateHostProgressCallback() -> *mut c_void;

    // MTGS functions
    fn MTGS_IsOpen() -> bool;
    fn MTGS_WaitForOpen() -> bool;
    fn MTGS_WaitForClose();
    fn MTGS_UpdateDisplayWindow();
    fn MTGS_WaitGS(block: bool, recursive: bool, x2: bool);
    fn MTGS_ToggleSoftwareRendering();
    fn MTGS_ResizeDisplayWindow(width: c_uint, height: c_uint, scale: f32);
    fn MTGS_PresentCurrentFrame();
    fn MTGS_RunOnGSThread(function: *const c_void);

    // GS functions
    fn GSGetCurrentRenderer() -> c_int;
    fn GSGetRendererName(renderer: c_int) -> *const c_char;
    fn GSgetTitleStats(stats: *mut c_void);
    fn GSgetInternalResolution(width: *mut c_int, height: *mut c_int);
    fn GSQueueSnapshot(path: *const c_char, gsdump_frames: c_uint);
    fn GSBeginCapture(path: *const c_char);
    fn GSEndCapture();
    fn GSWantsExclusiveFullscreen() -> bool;

    // PerformanceMetrics
    fn PerformanceMetrics_GetSpeed() -> f32;
    fn PerformanceMetrics_GetGPUUsage() -> f32;
    fn PerformanceMetrics_GetInternalFPS() -> f32;
    fn PerformanceMetrics_GetFPS() -> f32;
    fn PerformanceMetrics_GetCPUThreadUsage() -> f32;
    fn PerformanceMetrics_GetVUThreadUsage() -> f32;
    fn PerformanceMetrics_GetGSThreadUsage() -> f32;

    // InputManager
    fn InputManager_ReloadDevices();
    fn InputManager_CloseSources();
    fn InputManager_ReloadInputSources();
    fn InputManager_ReloadInputBindings();
    fn InputManager_ClearBindStateFromSource(key: c_uint);
    fn InputManager_MakeHostKeyboardKey(code: c_uint) -> c_uint;
    fn InputManager_HasAnyBindingsForSource(key: c_uint) -> bool;
    fn InputManager_EnumerateDevices() -> *const c_void;
    fn InputManager_EnumerateMotors() -> *const c_void;

    // SPU2
    fn SPU2_GetOutputVolume() -> c_uint;
    fn SPU2_IsOutputMuted() -> bool;

    // EmuFolders
    fn EmuFolders_SetAppRoot();
    fn EmuFolders_SetResourcesDirectory() -> bool;
    fn EmuFolders_SetDataDirectory(error: *mut c_void) -> bool;
    fn EmuFolders_GetResources() -> *const c_char;
    fn EmuFolders_GetSettings() -> *const c_char;
    fn EmuFolders_GetDataRoot() -> *const c_char;

    // SettingsInterface
    fn SettingsInterface_GetBoolValue(si: *const c_void, section: *const c_char, key: *const c_char, default_val: bool) -> bool;
    fn SettingsInterface_SetBoolValue(si: *const c_void, section: *const c_char, key: *const c_char, value: bool);
    fn SettingsInterface_GetIntValue(si: *const c_void, section: *const c_char, key: *const c_char, default_val: c_int) -> c_int;
    fn SettingsInterface_SetIntValue(si: *const c_void, section: *const c_char, key: *const c_char, value: c_int);
    fn SettingsInterface_GetStringValue(si: *const c_void, section: *const c_char, key: *const c_char) -> *const c_char;
    fn SettingsInterface_SetStringValue(si: *const c_void, section: *const c_char, key: *const c_char, value: *const c_char);
    fn SettingsInterface_RemoveEmptySections(si: *const c_void);
    fn SettingsInterface_IsEmpty(si: *const c_void) -> bool;
    fn SettingsInterface_IsDirty(si: *const c_void) -> bool;
    fn SettingsInterface_Save(si: *const c_void, error: *mut c_void) -> bool;
    fn SettingsInterface_Load(si: *const c_void) -> bool;
    fn SettingsInterface_GetFileName(si: *const c_void) -> *const c_char;

    // INISettingsInterface
    fn INISettingsInterface_Create(path: *const c_char) -> *mut c_void;
    fn INISettingsInterface_Destroy(si: *mut c_void);

    // FileSystem
    fn FileSystem_FileExists(path: *const c_char) -> bool;
    fn FileSystem_DeleteFilePath(path: *const c_char, error: *mut c_void) -> bool;
    fn FileSystem_DirectoryExists(path: *const c_char) -> bool;
    fn FileSystem_CreateDirectoryPath(path: *const c_char, recursive: bool) -> bool;
    fn FileSystem_WriteBinaryFile(path: *const c_void, data: *const u8, size: c_uint) -> bool;
    fn FileSystem_ReadBinaryFile(path: *const c_void, data: *mut *mut u8, size: *mut c_uint) -> bool;

    // Path
    fn Path_Combine(base: *const c_char, component: *const c_char) -> *const c_char;
    fn Path_GetDirectory(path: *const c_char) -> *const c_char;
    fn Path_GetFileName(path: *const c_char) -> *const c_char;
    fn Path_URLEncode(str: *const c_char) -> *const c_char;

    // Error
    fn Error_GetDescription(error: *const c_void) -> *const c_char;

    // HTTPDownloader
    fn HTTPDownloader_Create(user_agent: *const c_char) -> *mut c_void;
    fn HTTPDownloader_Destroy(dl: *mut c_void);
    fn HTTPDownloader_CreateRequest(
        dl: *mut c_void,
        url: *const c_char,
        callback: *const c_void,
        progress: *const c_void,
    );
    fn HTTPDownloader_HasAnyRequests(dl: *const c_void) -> bool;
    fn HTTPDownloader_PollRequests(dl: *mut c_void);
    fn HTTPDownloader_CancelAllRequests(dl: *mut c_void);

    // CrashHandler
    fn CrashHandler_Install();
    fn CrashHandler_SetWriteDirectory(path: *const c_char);

    // Console
    fn Console_WriteLn(message: *const c_char);
    fn Console_Error(message: *const c_char);
    fn Console_Warning(message: *const c_char);
    fn Console_WriteLnFmt(format: *const c_char, ...);

    // Achievements
    fn Achievements_GetHardcoreModeDisableTitle() -> *const c_char;
    fn Achievements_GetHardcoreModeDisableText(reason: *const c_char) -> *const c_char;
    fn Achievements_HasActiveGame() -> bool;
    fn Achievements_GetGameID() -> c_uint;
    fn Achievements_GetGameTitle() -> *const c_char;
    fn Achievements_GetRichPresenceString() -> *const c_char;
    fn Achievements_SwitchToRAIntegration();

    // DebugInterface
    fn DebugInterface_SetPauseOnEntry(pause: bool);

    // Log
    fn Log_SetConsoleOutputLevel(level: c_int);

    // StringUtil
    fn StringUtil_JoinString(begin: *const c_void, end: *const c_void, sep: *const c_char) -> *const c_char;
    fn StringUtil_Ellipsise(str: *const c_char, max_len: c_uint) -> *const c_char;
}
...
pub struct ProgressCallback {
    ...
    cancellable: bool,
    progress_range: u32,
    progress_value: c_void, // ProgressRange type
    title: String,
    status_text: String,
...
pub fn qt_host_initialize_config() -> Result<(), Error> {
    unsafe {
        ...
        if !EmuFolders_SetDataDirectory(ptr::null_mut()) {
...
pub fn qt_host_save_settings() {
    ...
    if let Some(ref timer) = unsafe { S_SETTINGS_SAVE_TIMER } {
        timer.stop();
    }
    unsafe { S_SETTINGS_SAVE_TIMER = None; }
}
...
pub fn qt_host_get_app_name_and_version() -> String {
    ...
    format!("PCSX2 {}", env!("GIT_REV", "unknown"))
}
